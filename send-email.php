...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Настройки за имейла
  $recipient = "simeonnedkov2006@gmail.com";
  ...
  if (!empty($service)) {
      $service_names = array(
          "small-basic" => "Малки обекти - Основен план",
          "small-extended" => "Малки обекти - Разширен план", 
          "medium-basic" => "Средни обекти - Основен план",
          "medium-extended" => "Средни обекти - Разширен план",
          "large-basic" => "Големи обекти - Основен план",
          "large-extended" => "Големи обекти - Разширен план",
          "custom" => "Персонализирани решения",
